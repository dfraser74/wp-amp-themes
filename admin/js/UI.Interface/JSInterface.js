...
var WPMPJSInterface =  function(){
	...
	return{	
		...
		AjaxUpload: new WPMPAjaxUpload(),   		// object that makes the upload of a form without refreshin via AJAX
		Preloader: new WPMPPreloader(),  		// the preloader object used for sending data to server through AJAX
		Loader: new WPMPLoader(),   				// the object used to display AJAX error messages
		...
		/*****************************************************************************************/
		/**
		 * initialize the WPMPJSInterface
		 * method type: LOCAL
		 * params: none
		 */
		init: function(){
			...
			jQuery(document).ready(function(){
                ...
                WPMPJSInterface.Loader.init();
				WPMPJSInterface.initObjects();
		...
		/*****************************************************************************************/
		/**
		 * initialize the WPMPJSInterface objects
		 * method type: LOCAL
		 * params: none
		 */
		...
		/*****************************************************************************************/
		/**
		 * add an object to the WPMPJSInterface
		 * method type: LOCAL
		 * params: @objName : the name of the object in the WPMPJSInterface
