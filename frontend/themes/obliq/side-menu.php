...
<style amp-custom="">
.ampstart-sidebar-faq a{cursor:pointer;text-decoration:none}.ampstart-navbar-trigger{line-height:3.5rem;font-size:2rem}.ampstart-navbar-close{color:#4a4a4a}.ampstart-headerbar-nav{-webkit-box-flex:1;-ms-flex:1;flex:1}.ampstart-nav-search{-webkit-box-flex:.5;-ms-flex-positive:.5;flex-grow:.5}.ampstart-headerbar .ampstart-nav-search:active,.ampstart-headerbar .ampstart-nav-search:focus,.ampstart-headerbar .ampstart-nav-search:hover{box-shadow:none}.ampstart-nav-search>input{border:none;border-radius:3px;line-height:normal}.ampstart-nav-dropdown{min-width:200px}.ampstart-nav-dropdown amp-accordion header{background-color:#fff;border:none}.ampstart-nav-dropdown amp-accordion ul{background-color:#fff}.ampstart-nav-dropdown .ampstart-dropdown-item,.ampstart-nav-dropdown .ampstart-dropdown>section>header{background-color:transparent;color:#000}.ampstart-nav-dropdown .ampstart-dropdown-item{color:#003f93}.ampstart-nav-dropdown .ampstart-dropdown-item a{color:#fff;font-weight:900;padding-left:1.5rem;padding-right:1.5rem;bottom:1rem}.ampstart-nav-dropdown .ampstart-dropdown-item-overlay{width:100%;height:6rem;background:-webkit-linear-gradient(bottom,rgba(0,0,0,.7),rgba(0,0,0,.08) 45px,transparent 60px,transparent);background:-moz-linear-gradient(bottom,rgba(0,0,0,.7),rgba(0,0,0,.08) 45px,transparent 60px,transparent);background:-o-linear-gradient(bottom,rgba(0,0,0,.7),rgba(0,0,0,.08) 45px,transparent 60px,transparent);background:linear-gradient(bottom,rgba(0,0,0,.7),rgba(0,0,0,.08) 45px,transparent 60px,transparent);background:-ms-linear-gradient(bottom,rgba(0,0,0,.7) 0,rgba(0,0,0,.08) 45px,transparent 60px,transparent 100%)}.ampstart-sidebar{background-color:#f0f0f0;color:#000;min-width:300px;width:300px}.ampstart-sidebar .ampstart-icon{fill:#4a4a4a}.ampstart-sidebar-header{line-height:3.5rem;min-height:3.5rem}.ampstart-sidebar .ampstart-faq-item,.ampstart-sidebar .ampstart-nav-item{margin:0 0 2rem}.ampstart-social-follow{height:6rem;width:100%}.ampstart-sidebar .ampstart-nav-dropdown{margin:0}.ampstart-sidebar .ampstart-navbar-trigger{line-height:inherit}.ampstart-dropdown-item{height:6rem}.ampstart-dropdown{min-width:200px}.ampstart-dropdown.absolute{z-index:100}.ampstart-dropdown.absolute>section,.ampstart-dropdown.absolute>section>header{height:100%}.ampstart-dropdown>section>header{background-color:transparent;border:0;color:#fff}.ampstart-dropdown>section>header:after{display:inline-block;content:"+";padding:0 0 0 1.5rem;color:#4a4a4a;float:right}.ampstart-dropdown>[expanded]>header:after{content:"–"}.absolute .ampstart-dropdown-items{z-index:200}.ampstart-dropdown-item{background-color:#000;color:#003f93;opacity:.9}.ampstart-dropdown-item:active,.ampstart-dropdown-item:hover{opacity:1}.category-cover{background-image:url('../img/article/cow.png')}.page-cover{background-image:url('../img/article/zebras.jpg')}
</style>
            ...
            <ul class="ampstart-dropdown-items list-reset m0 p0">
				<?php if( $categories ): ?>
					<?php foreach( $categories as $category ) : ?>
						<li class="ampstart-dropdown-item bg-cover category-cover">
							<div class="ampstart-dropdown-item-overlay absolute">
								<a href="<?php echo esc_url(get_category_link($category->cat_ID)); ?>" class="text-decoration-none absolute"><?php echo esc_html($category->cat_name); ?></a>
							</div>
						</li>
					<?php endforeach; ?>
				<?php endif; ?>
            ...
            <ul class="ampstart-dropdown-items list-reset m0 p0">
				<?php if( $pages ): ?>
					<?php foreach( $pages as $page ) : ?>
						<li class="ampstart-dropdown-item bg-cover page-cover">
                			<div class="ampstart-dropdown-item-overlay absolute">
                  				<a href="<?php echo esc_url(get_permalink($page->ID)); ?>" class="text-decoration-none absolute"><?php echo esc_html($page->post_title); ?></a>
							</div>
              			</li>
					<?php endforeach; ?>
				<?php endif; ?>
