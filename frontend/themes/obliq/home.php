...
<body>
  ...
  <figure class="ampstart-image-fullpage-hero m0 relative">
    <div class="bg-cover vw vh" layout="responsive" style="background-image:url('../img/article/elephants_narrow.png')"></div>
    <figcaption class="relative top-0 right-0 left-0">

      <header class="ampstart-header absolute bottom-0">
        <div class="ampstart-header-obliq"></div>
        <div class="ampstart-header-inner p3">
          <span class="ampstart-header-category mb2">Urban</span>
          <h3 class="mb1">The Year's Best Animal Photos</h3>
          <span>
            By J.T. Lee, January 18th, 2017
          </span>
          <h6 class="mt1"><a href="./article.php"> Read more</a></h6>
        </div>
    </header>
    </figcaption>
  </figure>
  ...
  <main id="content" role="main" class="">
    <div>
      <figure class="ampstart-article-image m0 relative">
        <figcaption class="absolute top-8 right-0 left-0">
          <header class="ampstart-article-header">
            <div class="ampstart-article-obliq"></div>
            <div class="ampstart-article-inner p3">
              <span class="ampstart-header-category mb2">Urban</span>
              <h3 class="mb1 text-ellipsis">The Year's Best Animal Photos</h3>
              <span>
                By J.T. Lee, January 18th, 2017
              </span>
              <h6 class="mt1"><a href="./article.php"> Read more</a></h6>
        ...
        <div class="bg-cover vh30 vw absolute" layout="responsive" style="background-image:url('../img/article/camels.jpg')"></div>
      </figure>
    </div>
    <div>
      <figure class="ampstart-article-image m0 relative">
        ...
        <div class="bg-cover vh30 vw absolute" layout="responsive" style="background-image:url('../img/article/zebras.jpg')"></div>
      </figure>
    </div>
    <div>
      <figure class="ampstart-article-image m0 relative">
        ...
        <div class="bg-cover vh30 vw absolute" layout="responsive" style="background-image:url('../img/article/cow.png')"></div>
      </figure>
    </div>
  </main>
</body>
